...
process trim {
    ...
    """
    trimmomatic PE -threads ${params.threads} $forward $reverse -baseout ${dataset_id}.fq.gz ILLUMINACLIP:${workflow.projectDir}/adapters/illumina_adapters.fa:2:80:10 MINLEN:45
